...
> vers cet audit, entièrement clos. Voir aussi `docs/ETAT_DU_CHANTIER.md` pour le bilan de
> clôture. Le contenu ci-dessous n'est plus mis à jour ; il fait foi pour comprendre *pourquoi*

...
export type { ExpositionConsolidee, FundTopHoldingItem, HoldingDetail, HoldingImmobilier, HoldingImmobilierInput, IndicateursSituation, LignePatrimoineFiltree, LignesPatrimoineFiltreesResponse, Loan, LoanInput, LoanUpdateInput, PatrimoineHistoryPoint, PatrimoineHistoryResponse, PatrimoineNet } from './types/patrimoine'

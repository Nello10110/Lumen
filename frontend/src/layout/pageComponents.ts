...
// exactement les mêmes chemins. Fichier séparé de `routes.ts` (qui reste des
// métadonnées pures, sans dépendance sur les composants de page) et de `App.tsx`
// (dont l'export d'une simple constante à côté du composant `App` cassait le
// fast-refresh).
